...
class ExperimentGUI:
    ...
    def instruction(self):
        ...
        title = ttk.Label(self.start_frame, text="Welcome to the Experiment!\n", font=("Arial", 30), justify=tk.CENTER)
        ...
        label = ttk.Label(self.start_frame, text="In this experiment, you will be given a video of a person performing an activity. " +
                          ...
                          " the first 15 minutes, you will get a 3-minute break, followed by another 15 minutes. \n\nIf you have any questions regarding the experiment," +
        ...
        start_button = customtkinter.CTkButton(self.start_frame, text="Start", command=self.show_screen_1, corner_radius=0, font=("Arial", 25))
    ...
    def part1_instruction(self):
        ...
        next_button = customtkinter.CTkButton(self.screen_1_frame, text="Next", command=self.root.destroy, corner_radius=0, font=("Arial", 25)) #command=self.show_screen_2
