...
def reba_video_analyzer(video_file_path=None,test=False,frontview=True,show_plots=False,camera_frames_per_second = 30,create_csv_from_data = True):
    ...
    while cap.isOpened():
        ...
        try: 
            ...
            joint_names_str = ('l_shoulder','r_shoulder','l_hip','r_hip','l_knee','r_knee','l_ankle','r_ankle','nose','l_elbow','r_elbow','l_wrist','r_wrist','l_index','r_index','l_pinky','r_pinky')
    ...
    reba_angles_dataframe = {'frame':list(range(len(angle_deg_neck))),'l_upper_arm_sag':l_upper_arm_sagital_angles,'l_upper_arm_frontal':l_upper_arm_frontal_angles,'r_upper_arm_sag':r_upper_arm_sagital_angles,'r_upper_arm_frontal':r_upper_arm_frontal_angles,'l_lower_arm':angle_deg_l_elbow,'r_lower_arm':angle_deg_r_elbow,
                        'l_wrist':angle_deg_l_wrist,'r_wrist':angle_deg_r_wrist,
                        'l_knee':angle_deg_l_knee,'r_knee':angle_deg_r_knee,'neck':angle_deg_neck,'trunk_angle':angle_deg_mid_hip}
    ...
    gui_peaks_dataframe = {'peaks_i':all_peaks_i,'peak_val':list(peak_props['peak_heights'])}
