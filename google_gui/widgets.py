...
class VideoWidget():
    def __init__(self,video_file_path, gui_dataframe_output,peaks_dataframe,reba_data,count,condition,object_data=None,timer_callback=None):
        # self.root = tk.Tk()
        #style
        ...
        # Variables
        self.timer_length = 20 ####### CONTROL TIME HERE **900 is 15 minutes
    ...
    def text_display_and_seek(self, button_data, button_number):
        ...
        self.display = ttk.Label(self.output_frame, text=button_data[button_number]['text'], foreground='darkorange', font=("Arial", 20))
    ...
    def add_buttons(self, data, frame):
        ...
        for entry in data:
            ...
            new_button = tk.Radiobutton(frame, bg="darkorange", fg="black", text=button_text, indicatoron=False, borderwidth=5, value=button_counter, variable=button, command=(lambda button_label=button_text: self.text_display_and_seek(data, button_label)), font=("Arial", 25))
            new_button.pack(side="left", anchor="center", padx=1)
